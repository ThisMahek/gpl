     ...
     <div class="card-body">
           ...
           <table class="table table-bordered table-responsive datatable nowrap w-100 ">
                    ...
                    <?php if(!empty($manage_category)):
                      $i=0;
                      ?>
                     <?php foreach($manage_category as $row):
                      $i++;
                      ?>
                                            <tr>
                                                <td><?= $i ?></td>
                                                ...
                                                <!-- <td><button class="btn btn-success btn-sm">Active</button></td> -->
                                                 ...
                                                 <td>
                                                          ...
                                                          if($row['status'] == 1)
                                                            {
                                                            ?> 
                                                        <a  onclick="return confirm('Are you sure you want to inactive?');" href='<?= base_url()?>sportscat/update_sport_category_status?id=<?=$row['id']?>&status=<?=$row['status']?>'><button class="btn btn-success btn-sm">Active</button></a>
                                                        <?php
                                                            }
                                                          else
                                                          {?>
                                                        <a  onclick="return confirm('Are you sure you want to active?');" href='<?= base_url()?>sportscat/update_sport_category_status?id=<?=$row['id']?>&status=<?=$row['status']?>'><button class="btn btn-danger btn-sm">Inactive</button></a>
                                                        <?php
                                                          }
                                                          ?>
                                              </td> 
                                               <!--  <td>
                                                ...
                                                <td>
                                                  <div class="action-btn">
                                                      ...
                                                      <!-- <button class="btn btn-danger btn-sm"><i class="bx bxs-trash"></i></button> -->
                                                      <a href="<?= base_url('sportscat/delete_category')?>/<?=$row['id']?>"><button type="button"  onclick="return confirm('Are you sure you want to delete this category?');"class="btn btn-danger btn-sm"><i class="bx bxs-trash" aria-hidden="true"></i> </button></a>
                                                  </div>
                                                </td>
                                             </tr>
                                             <?php endforeach;?>
   ...
   <div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <form action="<?= base_url('sportscat/add_category')?>" method="post" enctype="multipart/form-data">
                          <div class="modal-body">
                              ...
                              <!--    <div class="mb-3">
                                    ...
                                    <input type="checkbox" class="form-check-input" name="status" id="active" name="status" <?= ('checked')?'1':'0'?> checked>
   ...
   <div class="modal fade" id="update<?= $row['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <form action="<?= base_url()?>sportscat/update_category" method="post" >
                          <div class="modal-body">
                                   <div class="mb-3">
                                       <label class="mb-2">Name</label>
