...
<?php include('includes/sidebar.php')?>
 <div class="card shadow">
     <div class="card-header">
         <div class="row">
             <div class="col-md-8 col-8">
                 <h4 class="mb-sm-0 font-size-18">Update player details</h4>
             </div>
     ...
     <div class="card-body">
         <form action="<?= base_url('player/update_player')?>" method="post">
             <div class="row">
                ...
                <?php endif;?>
                 ...
                 <div class="col-md-6">
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control"  name="player_name" value="<?= $row['player_name']?>" required>
                     </div>
                 </div>
                 <div class="col-md-6">
                     <div class="mb-3">
                 ...
                 <div class="col-md-6">
                     <div class="mb-3">
                         ...
                         <input type="tel" class="form-control" name="mobile" value="<?= $row['mobno']?>" required>
                     </div>
                 </div>
             ...
             <!--     <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                     <div class="mb-3">
                        ...
                        <input type="text" name="role" value="<?= $row['position']?>" class="form-control">
                     </div>
                 </div>
